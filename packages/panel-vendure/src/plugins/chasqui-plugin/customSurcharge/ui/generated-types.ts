...
export namespace CreateExample {
  export type Variables = CreateExampleMutationVariables;
  export type Mutation = CreateExampleMutation;
  export type CreateExample = (NonNullable<CreateExampleMutation['createExample']>);
}
...
export namespace UpdateExample {
  ...
  export type UpdateExample = (NonNullable<UpdateExampleMutation['updateExample']>);
}

export namespace GetExamples {
  export type Variables = GetExamplesQueryVariables;
  export type Query = GetExamplesQuery;
  export type Examples = (NonNullable<GetExamplesQuery['examples']>);
  export type Items = NonNullable<(NonNullable<(NonNullable<GetExamplesQuery['examples']>)['items']>)[number]>;
}
