...
const result: PossibleTypesResultData = {
  possibleTypes: {
    ...
    RegisterCustomerAccountResult: ['MissingPasswordError', 'NativeAuthStrategyError', 'Success'],
    ...
    UpdateCustomerPasswordResult: ['InvalidCredentialsError', 'NativeAuthStrategyError', 'Success'],
