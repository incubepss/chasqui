...
export class AccountCustomerDetailsComponent implements OnInit {
  ...
  ngOnInit() {
    this.dataService
      .query<GetActiveCustomer.Query>(GET_ACTIVE_CUSTOMER, {}, 'network-only')
      .pipe(
  ...
  updateDetails() {
    ...
    this.dataService
      .mutate<UpdateCustomerDetails.Mutation, UpdateCustomerDetails.Variables>(UPDATE_CUSTOMER_DETAILS, {
        input,
      })
      .subscribe(() => {
